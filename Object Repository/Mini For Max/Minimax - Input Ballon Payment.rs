...
<MobileElementEntity>
   ...
   <name>Minimax - Input Ballon Payment</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and (@text = '20,000,000' or . = '20,000,000') and @resource-id = 'balloonpayment']</locator>
