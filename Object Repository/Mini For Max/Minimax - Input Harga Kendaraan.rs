...
<MobileElementEntity>
   ...
   <name>Minimax - Input Harga Kendaraan</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and @resource-id = 'hargakendaraan' and (@text = '' or . = '')]</locator>
