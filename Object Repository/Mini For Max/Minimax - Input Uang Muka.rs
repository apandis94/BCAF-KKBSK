...
<MobileElementEntity>
   ...
   <name>Minimax - Input Uang Muka</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.EditText' and @resource-id = 'uangmuka-percent' and (@text = '' or . = '')]</locator>
