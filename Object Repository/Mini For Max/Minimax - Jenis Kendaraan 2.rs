...
<MobileElementEntity>
   ...
   <name>Minimax - Jenis Kendaraan 2</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.view.View' and (@text = 'Passenger' or . = 'Passenger') and @resource-id = 'jeniskendaraan']</locator>
