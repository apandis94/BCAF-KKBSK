...
<MobileElementEntity>
   ...
   <name>Minimax - Jenis Pembiayaan</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.view.View' and (@text = 'Mobil Baru' or . = 'Mobil Baru') and @resource-id = 'jenispembiayaan']</locator>
