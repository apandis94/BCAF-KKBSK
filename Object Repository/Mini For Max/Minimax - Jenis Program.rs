...
<MobileElementEntity>
   ...
   <name>Minimax - Jenis Program</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.view.View' and (@text = 'Mini for Max' or . = 'Mini for Max') and @resource-id = 'jenisprogram']</locator>
