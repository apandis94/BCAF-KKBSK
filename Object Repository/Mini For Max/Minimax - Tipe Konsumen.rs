...
<MobileElementEntity>
   ...
   <name>Minimax - Tipe Konsumen</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.view.View' and (@text = 'Perorangan' or . = 'Perorangan') and @resource-id = 'tipekonsumen']</locator>
