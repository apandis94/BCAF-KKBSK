...
<MobileElementEntity>
   ...
   <name>Minimax - Tujuan Penggunaan</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.view.View' and (@text = '--Pilih--' or . = '--Pilih--') and @resource-id = 'tujuanpenggunaan']</locator>
