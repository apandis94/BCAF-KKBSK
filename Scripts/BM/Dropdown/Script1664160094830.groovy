...
Mobile.tap(findTestObject('Object Repository/Test Drop Down/android.widget.AutoCompleteTextView - --Pilih--'), 0, FailureHandling.CONTINUE_ON_FAILURE)

int timeout = 0
Scroll.scrollListToElementWithText('ADI SUCIPTO', timeout)
